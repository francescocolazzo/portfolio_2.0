...
function Model(props) {
  ...
  useFrame((state) => {
    const canvasElement = document.querySelector('.pippo');
    //canvasElement.style.width = window.innerWidth > 768 ? '300px': '40vw';
    ...
    //   canvasElement.style.width = '100%';
    // }
    //canvasElement.style.height = window.innerWidth < 768 ? '40vh': '70vh';
   ...
   // props.reference.current.style.height = window.innerWidth < 900 ? '100%': '40vh';
    ...
    state.camera.fov = window.innerWidth < 768 ? 80 : 65;
  ...
  return (
    <group ref={group} {...props} dispose={null} className='filii'>
      <group rotation-x={-0.425} position={[0, -0.04, 0.41]}  className='filii'>
        <group position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}  className='filii'>
...
export default function App() {
  ...
  return (
    <Canvas ref={canv} camera={{ position: [-5, 0, -15], fov: 65 }}  className='pippo' style={{ width: '40vw', height:'70vh',  cursor:'default'}}>
